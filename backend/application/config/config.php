...
|
*/
$config['base_url'] = 'https://sleekware.test/';
...
|
*/
$config['subclass_prefix'] = 'Sleekwaredb_';
...
*/
$config['composer_autoload'] = 'backend/vendor/autoload.php';
...
|
*/
$config['encryption_key'] = PASSCODE;
...
$config['sess_cookie_name'] = 'sleek_session';
